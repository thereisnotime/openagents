...
def build_phase_gate_directive(
    ...
    if role == "plan":
        return (
            ...
            "You have been pulled in while the requirement in this channel is "
            f"still being clarified by {who}. Answer what was actually asked: "
            "feasibility, risks, options, rough effort, or questions of your own "
            "that need answering before this can be built.\n"
